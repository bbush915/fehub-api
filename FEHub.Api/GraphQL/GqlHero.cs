...
internal sealed class GqlHero : ObjectGraphType<Hero>
{
    public GqlHero(IDataLoaderContextAccessor accessor)
    {
        ...
        this
            .Field<GqlArtist, Artist>(nameof(Hero.Artist))
        ...
        this
            .Field<ListGraphType<GqlHeroSkill>, IEnumerable<HeroSkill>>(nameof(Hero.HeroSkills))
        ...
        this
            .Field<ListGraphType<GqlHeroVoiceActor>, IEnumerable<HeroVoiceActor>>(nameof(Hero.HeroVoiceActors))
