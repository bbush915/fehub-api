        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Accessories_AccessoryType_Enum_Constraint", "[AccessoryType] IN(1, 2, 3, 4)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Skills_SkillType_Enum_Constraint", "[SkillType] IN(1, 2, 3, 4, 5, 6, 7)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Heroes_Color_Enum_Constraint", "[Color] IN(1, 2, 3, 4)");
                    table.CheckConstraint("CK_Heroes_Gender_Enum_Constraint", "[Gender] IN(1, 2, 3)");
                    table.CheckConstraint("CK_Heroes_MovementType_Enum_Constraint", "[MovementType] IN(1, 2, 3, 4)");
                    table.CheckConstraint("CK_Heroes_Weapon_Enum_Constraint", "[Weapon] IN(1, 2, 3, 4, 5, 6, 7, 8, 9)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SkillMovementTypes_MovementType_Enum_Constraint", "[MovementType] IN(1, 2, 3, 4)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SkillWeaponEffectivenesses_WeaponEffectivenessType_Enum_Constraint", "[WeaponEffectivenessType] IN(1, 2, 3)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SkillWeaponTypes_Color_Enum_Constraint", "[Color] IN(1, 2, 3, 4)");
                    table.CheckConstraint("CK_SkillWeaponTypes_Weapon_Enum_Constraint", "[Weapon] IN(1, 2, 3, 4, 5, 6, 7, 8, 9)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_HeroVoiceActors_Language_Enum_Constraint", "[Language] IN(1, 2)");
                    table.ForeignKey(
